...
import type {MenuItem, Course, ComboDeal, Orderline, AllergyCard} from "./menuTypes";
...
const brownie: MenuItem = {
  ...
  price: 6.0,
  discountPercent: 10,
  availableFrom: new Date("2026/11/20"),
  nutrition: {
    calories: 450,
...
function firstMatch<T>(data: T[], criteria: (d: T) => boolean | undefined) {
...
console.log(updateItem(soup, { price: 7.00})); // Declared a number not string in MenuItem interface
